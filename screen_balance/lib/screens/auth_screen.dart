                    ...
                    ClipRRect(
                      ...
                      child: BackdropFilter(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            color: Colors.white.withOpacity(0.9), // Pure white high opacity
                            borderRadius: BorderRadius.circular(32),
                            border: Border.all(
                              color: Colors.white,
                              width: 1.5,
      ...
      child: Column(
        ...
        children: [
          ...
          ElevatedButton(
            ...
            child: const Text('Initialize & Begin Quiz', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
          ),
        ],
      ),
    );
